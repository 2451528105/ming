...
type RequestMessage struct {
	...
	Payload       []byte                 `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"` // 这里再塞 request.proto 里的业务请求体
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ServerMessage struct {
	...
	MsgTag        string                 `protobuf:"bytes,5,opt,name=msg_tag,json=msgTag,proto3" json:"msg_tag,omitempty"`
	Data          []byte                 `protobuf:"bytes,6,opt,name=data,proto3" json:"data,omitempty"` // 这里再塞 push.proto 里的业务响应/推送体
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_common_proto_rawDesc = "" +
	"\n" +
	"\fcommon.proto\x12\x02pb\"\x94\x01\n" +
	"\x06Header\x12\x10\n" +
	...
	"\x04data\x18\x06 \x01(\fR\x04dataB\x06Z\x04./pbb\x06proto3"
